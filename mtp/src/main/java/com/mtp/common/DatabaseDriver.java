...
import com.mtp.events.federation.Advertisement.AdvertiseE2EFederationReply;
import com.mtp.events.federation.Advertisement.AdvertiseE2EFederationRequest;
...
import com.mtp.extinterface.nbi.swagger.model.Fed_NfviPops;
import com.mtp.extinterface.nbi.swagger.model.Fed_NfviPopsInner;
import com.mtp.extinterface.nbi.swagger.model.Fed_NfviPopsInnerNfviPopAttributes;
...
//            }
    ...
    public void handle_AdvertiseE2EFederatedRequest(AdvertiseE2EFederationRequest e2eadvreq) {
        ...
        Fed_InlineResponse2003 resp = new Fed_InlineResponse2003();
        List<NfviPop> poplist = new ArrayList();
        List<NfviPopsInnerNfviPopAttributes> popattrlist = new ArrayList();
        ...
        Fed_NfviPops popslist = new Fed_NfviPops();
        //retrieve zone and resources for each nfvipop
        for (int i = 0; i < poplist.size(); i++) {
            NfviPop popel = poplist.get(i);
            Fed_NfviPopsInnerNfviPopAttributes popattr = new Fed_NfviPopsInnerNfviPopAttributes();
            //fill nfvipop values
            popattr.setVimId(popel.getVimId());
            ...
            Fed_NfviPopsInner popinel = new Fed_NfviPopsInner();
            popinel.setNfviPopAttributes(popattr);

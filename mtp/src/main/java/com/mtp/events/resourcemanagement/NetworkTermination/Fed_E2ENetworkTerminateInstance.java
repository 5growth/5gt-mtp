...
public class Fed_E2ENetworkTerminateInstance {
    ...
    private List<String> locicalPathList;

    public Fed_E2ENetworkTerminateInstance() {
        reqid = 0;
        servid = 0;
        interdomainLinksMap = new HashMap();
        fed_interdomainLinksMap = new HashMap();
        intraPopLinksMap = new HashMap();
        wanLinksMap = new HashMap();
        wimPopListMap = new HashMap();
        vimPopListMap = new HashMap();
        wimNetworkTypeMap = new HashMap();
        vimNetworkTypeMap = new HashMap();
        wanResourceIdListMap = new HashMap();
        netServIdList = new ArrayList();
        locicalPathList = new ArrayList();
    }

    public Fed_E2ENetworkTerminateInstance(long reqid, long servid, HashMap<Integer, ArrayList<Long>> wimdomlistMap, HashMap<Integer, ArrayList<Long>> vimdomlistMap, HashMap<Integer, ArrayList<Long>> interdomainLinksMap, HashMap<Integer, ArrayList<Long>> fed_interdomainLinksMap, HashMap<Integer, ArrayList<Long>> intraPopLinksMap, HashMap<Integer, ArrayList<Long>> wanLinksMap, HashMap<Integer, ArrayList<Long>> wimPopListMap, HashMap<Integer, ArrayList<Long>> vimPopListMap, HashMap<Integer, ArrayList<String>> wimNetworkTypeMap, HashMap<Integer, ArrayList<String>> vimNetworkTypeMap, HashMap<Integer, ArrayList<Long>> wanResourceIdListMap, List<String> netServIdList, List<String> locicalPathList) {
        this.reqid = reqid;
        this.servid = servid;
        ...
        this.locicalPathList = locicalPathList;
    }
    ...
    public List<String> getLocicalPathList() {
        return locicalPathList;
    }

    public void setLocicalPathList(List<String> locicalPathList) {
        this.locicalPathList = locicalPathList;
    }

...
public class Fed_E2ENetworkTerminateReply {

    private long reqid;
    private long servid; //service identifiers
    private List<String> netServIdList; //contains vim computation info 

    public Fed_E2ENetworkTerminateReply() {
        reqid = 0;
        servid = 0;
        netServIdList = null;
    }

    public Fed_E2ENetworkTerminateReply(long reqid, long servid, List<String> netServIdList) {
        this.reqid = reqid;
        this.servid = servid;

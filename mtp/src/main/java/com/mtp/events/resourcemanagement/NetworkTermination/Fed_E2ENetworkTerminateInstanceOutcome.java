...
public class Fed_E2ENetworkTerminateInstanceOutcome {
    ...
    public Fed_E2ENetworkTerminateInstanceOutcome() {
        reqid = 0;
        servid = 0;
        netServIdList = null;
    ...
    public Fed_E2ENetworkTerminateInstanceOutcome(long reqid, long servid, List<String> netServIdList, List<String> logicalPathList) {
        this.reqid = reqid;
        this.servid = servid;

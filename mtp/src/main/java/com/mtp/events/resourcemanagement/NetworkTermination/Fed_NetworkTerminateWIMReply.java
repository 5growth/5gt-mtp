...
public class Fed_NetworkTerminateWIMReply {
    ...
    public Fed_NetworkTerminateWIMReply() {
        this.reqid = 0;
        this.servid = 0;
    ...
    public Fed_NetworkTerminateWIMReply(long reqid, long servid, HashMap<Integer, ArrayList<Boolean>> outcomeListMap, HashMap<Integer, ArrayList<Integer>> errorcodeListMap, HashMap<Integer, ArrayList<String>> errormsgListMap) {
        this.reqid = reqid;
        this.servid = servid;

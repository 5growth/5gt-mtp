...
public class Fed_NetworkTerminateDBQuery {

    private long reqid;
    private long servid; //service identifiers
    private List<String> netServIdList; //contains vim computation info

    public Fed_NetworkTerminateDBQuery() {
        reqid = 0;
        servid = 0;
        netServIdList = null;
    }

    public Fed_NetworkTerminateDBQuery(long reqid, long servid, List<String> netServIdList) {
        this.reqid = reqid;
        this.servid = servid;

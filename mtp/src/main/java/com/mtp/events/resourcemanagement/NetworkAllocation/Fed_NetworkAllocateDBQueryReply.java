...
public class Fed_NetworkAllocateDBQueryReply {
    ...
    public Fed_NetworkAllocateDBQueryReply() {
        reqid = 0;
        servid = "";
        logicalLPathId = 0;

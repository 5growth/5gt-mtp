...
public class Fed_NetworkTerminateDBQueryOutcome {
    ...
    public Fed_NetworkTerminateDBQueryOutcome(long reqid, long servid, HashMap<Integer, ArrayList<Long>> wimdomlistMap, HashMap<Integer, ArrayList<Long>> vimdomlistMap, HashMap<Integer, ArrayList<Long>> interdomainLinksMap,HashMap<Integer, ArrayList<Long>> fed_interdomainLinksMap, HashMap<Integer, ArrayList<Long>> intraPopLinksMap, HashMap<Integer, ArrayList<Long>> wanLinksMap, HashMap<Integer, ArrayList<Long>> wimPopListMap, HashMap<Integer, ArrayList<Long>> vimPopListMap, HashMap<Integer, ArrayList<String>> wimNetworkTypeMap, HashMap<Integer, ArrayList<String>> vimNetworkTypeMap, HashMap<Integer, ArrayList<Long>> wanResourceIdListMap, List<String> netServIdList, List<String> locicaPathList) {
        this.reqid = reqid;
        this.servid = servid;

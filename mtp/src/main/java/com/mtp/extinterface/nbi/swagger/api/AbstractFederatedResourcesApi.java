...
public class AbstractFederatedResourcesApi {
    ...
    @ApiOperation(value = "Retrieve aggregated federated Cloud NFVI-PoP and Inter-NFVI-PoP Connectivity", notes = "Retrieve federated Cloud NFVI-PoP and Inter-NFVI-PoP Connectivity", response = Fed_InlineResponse2003.class, tags={ "SOInterface" })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful operation", response = Fed_InlineResponse2003.class),

...
public class Fed_NfviPopsInnerNfviPopAttributes   {
  ...
  /**
   **/
  public Fed_NfviPopsInnerNfviPopAttributes pnflist(PNFlist pnflist) {
   ...
   **/
  public Fed_NfviPopsInnerNfviPopAttributes geographicalLocationInfo(String geographicalLocationInfo) {
   ...
   **/
  public Fed_NfviPopsInnerNfviPopAttributes vimId(String vimId) {
    this.vimId = vimId;
    return this;
  }
 ...
 /**
   * Identification of the Federated_VIM.
   **/
  public Fed_NfviPopsInnerNfviPopAttributes federatedVimId(String federatedVimId) {
    this.federatedVimId = federatedVimId;
    return this;
  }

  
  @ApiModelProperty(required = true, value = "Identification of the Federated_VIM.")
  ...
  /**
   **/
  public Fed_NfviPopsInnerNfviPopAttributes networkConnectivityEndpoint(List<NfviPopsInnerNfviPopAttributesNetworkConnectivityEndpoint> networkConnectivityEndpoint) {
   ...
   **/
  public Fed_NfviPopsInnerNfviPopAttributes nfviPopId(String nfviPopId) {
  ...
  /**
   **/
  public Fed_NfviPopsInnerNfviPopAttributes resourceZoneAttributes(List<NfviPopsInnerNfviPopAttributesResourceZoneAttributes> resourceZoneAttributes) {
   ...
   **/
  public Fed_NfviPopsInnerNfviPopAttributes mecCapable(String mecCapable) {
  ...
  /**
   **/
  public Fed_NfviPopsInnerNfviPopAttributes mecRegions(List<MECRegionInfo> mecRegions) {
   ...
   **/
  public Fed_NfviPopsInnerNfviPopAttributes radioCapable(String radioCapable) {
  ...
  /**
   **/
  public Fed_NfviPopsInnerNfviPopAttributes radioCoverageAreas(List<NfviPopsInnerNfviPopAttributesRadioCoverageAreas> radioCoverageAreas) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Fed_NfviPopsInnerNfviPopAttributes nfviPopsInnerNfviPopAttributes = (Fed_NfviPopsInnerNfviPopAttributes) o;
